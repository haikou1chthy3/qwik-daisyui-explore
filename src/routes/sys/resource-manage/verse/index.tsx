...
import { MenuItem } from "~/components/search-menu/tree-menu";
import {
  Link,
  useContent,
  useLocation,
...
import { calcPageRange, i18n } from "~/utils/else-util";
      ...
      >
        ...
        >
          ...
          <div class="my-5 flex shadow">
            ...
            <div class="mr-1">
              <ListSelector searchKey="Lookup" />
            </div>
            <div class="mr-1">
              <ListSelector searchKey="Lookup类型" />
            </div>
